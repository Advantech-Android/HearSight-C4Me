    ...
    class MainRecyclerViewHolder(
                ...
                when (user.status) {
                    "ONLINE" -> {
                        ...
                        cardViewVideoCallClick.setOnClickListener {
                            ...
                            SnackBarUtils.showSnackBar(binding.root, RecyclerViewFields.CALL_CONNECTED)
        ...
        private fun deleteContacts(
            ...
            hastContactRef.removeValue().addOnSuccessListener {
                ...
                SnackBarUtils.showSnackBar(binding.root, RecyclerViewFields.REMOVED_CONTACT.replace("-",userName))
                ...
                .addOnFailureListener { exception ->
                    ...
                    SnackBarUtils.showSnackBar(binding.root, RecyclerViewFields.REMOVE_HOST_CONTACT.replace("-",exception.message!!))
                }
        }

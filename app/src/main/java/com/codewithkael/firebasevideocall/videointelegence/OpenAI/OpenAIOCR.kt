...
//
//@AndroidEntryPoint
//class OpenAIOCR : CameraActivity(), UvcCapturerNew.USBPreview, TextToSpeech.OnInitListener {
//    @Inject
...
//                this@OpenAIOCR // get this onPreviewStart() data from UvcCapturerNew class
//
...
//                Toast.makeText(this@OpenAIOCR, "play", Toast.LENGTH_SHORT).show()
//                //tts start
...
//                Toast.makeText(this@OpenAIOCR, "pause", Toast.LENGTH_SHORT).show()
...
//                Toast.makeText(this@OpenAIOCR, "Exit", Toast.LENGTH_SHORT).show()
//                webRTCClient.onPreviewStop {}
//                finish()
//            }
//            // Buttons for switching prompts
//            btnAINav.setOnClickListener {
//                Toast.makeText(this@OpenAIOCR, "AI Navigator", Toast.LENGTH_SHORT).show()
//                currentPromptIndex = 0
//
//            }
//            btnCurrency.setOnClickListener {
//                Toast.makeText(this@OpenAIOCR, "Currency", Toast.LENGTH_SHORT).show()
//                currentPromptIndex = 1
//
//            }
//            btnCommodity.setOnClickListener {
//                Toast.makeText(this@OpenAIOCR, "Commodity", Toast.LENGTH_SHORT).show()
//                currentPromptIndex = 2
//            }
//            btnOCR.setOnClickListener {
//                Toast.makeText(this@OpenAIOCR, "OCR", Toast.LENGTH_SHORT).show()

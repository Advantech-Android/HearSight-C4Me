...
protected Context context;
    ...
    public synchronized void open(final UsbControlBlock ctrlBlock, Context ctx) {
...
//			long id_camera, int venderId, int productId, int fileDescriptor, int busNum, int devAddr, String usbfs
		...
		*/
            Toast.makeText(context, "UVC Camera open failed", Toast.LENGTH_SHORT).show();
            return;
        }
